odoo.define('sure_book.models', function (require) {
"use strict";
...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'res.partner',
        fields: ['name','street','city','state_id','country_id','vat','room_no','room_id','phone','zip','mobile','email','barcode','write_date','property_account_position_id','check_in'],
        domain: [['customer','=',true],['check_in','=',true]], 
        loaded: function(self,partners){
            self.partners = partners;
//            console.log('====self.partners=========='+self.partners);
