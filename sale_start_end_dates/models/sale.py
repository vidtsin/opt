...
#  TEsting ..Getting product based on category
    ...
    def get_products(self):
        ...
        print "vals=------>>", vals
# Testing ... Getting Sale order line based on date
    @api.onchange('date_order')
    def insert_fetch_order(self):
        vals = {
            'start_date': '2017-05-01T12:00:00',
            'end_date': '2017-08-01T12:00:00',
        }
        self.fetch_order_line(vals)
    def fetch_order_line(self, vals):
        rec = []
        start_date = vals['start_date']
        end_date = vals['end_date']
        print " vals fetch order line==---->", vals
...
class SaleOrderLine(models.Model):
    ...
    must_have_dates = fields.Boolean(related='product_id.must_have_dates', readonly=True)
    
    #states={'checkout': [('readonly', True)]},, states={'checkout': [('readonly', True)]}
