odoo.define('booking.scheduler', function (require) {
"use strict";
...
var QWeb = core.qweb;
    ...
    var SchedulerHomePage = Widget.extend({
        start: function() {
            ajax.loadJS('/booking/static/js/jquery/jquery-1.9.1.min.js');
    ...
    core.action_registry.add("booking.homepage", SchedulerHomePage);
});
