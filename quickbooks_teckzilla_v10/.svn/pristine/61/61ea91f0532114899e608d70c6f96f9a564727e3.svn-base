...
class quick_configuration(models.Model):
    ...
    request_token_url = fields.Char('Request Token Url', size=264, required="1")
    access_token_url = fields.Char('Access Token Url', size=264, required="1")
    authorization_base_url = fields.Char('Authorization Base Url', size=264, required="1")
    company = fields.Char('Company Id', size=264, required="1")
