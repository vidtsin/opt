...
class FieldsProjectTask(models.Model):
    ...
    # ord_obj = self.env['project.task'].search([('name', '=', self.sale_ord)])
    ...
    def send_install_email(self):
        ...
        # if self.signature_cust_install_image:
        #     attachment_ids.append(self.env['ir.attachment'].create({
        #         'name': 'Customer Signature.pdf',
        #         'datas': self.signature_cust_install_image,
        #         'datas_fname': 'Customer Signature',
        #         'res_model': 'music_audiofile',
        #         'type': 'binary'
        #     }).id)
        # if self.signature_signature_install_image:
        #     attachment_ids.append(self.env['ir.attachment'].create({
        #         'name': 'Signature.pdf',
        #         'datas': self.signature_signature_install_image,
        #         'datas_fname': 'Signature',
        #         'res_model': 'music_audiofile',
        #         'type': 'binary'
        #     }).id)
        # if self.signature_dealer_install_image:
        #     attachment_ids.append(self.env['ir.attachment'].create({
        #         'name': 'Dealer.pdf',
        #         'datas': self.signature_dealer_install_image,
        #         'datas_fname': 'Dealer',
        #         'res_model': 'music_audiofile',
        #         'type': 'binary'
        #     }).id)
